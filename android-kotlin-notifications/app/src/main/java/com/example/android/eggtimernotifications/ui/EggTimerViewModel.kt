...
class EggTimerViewModel(private val app: Application) : AndroidViewModel(app) {
    ...
    // AlarmManager keeps track of the desired time selection and will trigger
    // the onReceive() function of AlarmReceiver.kt when the time is up.
    ...
    /**
     * This function creates an alarm with the selected time interval when the user enables the egg timer.
    ...
    private fun startTimer(timerLengthSelection: Int) {
        _alarmOn.value?.let {
            if (!it) {
                ...
                // Deletes the previous notification from the status bar.
